...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Roboto:300,400,500,700&subset=latin,cyrillic' rel='stylesheet' type='text/css'>    <?= Html::csrfMetaTags() ?>
    <?= Html::csrfMetaTags() ?>
            ...
            <div class="right-bar">
                <div class="cur_user-info">
                    <div id="top_user-link" class="cur_user-link">
                        ...
                        <img class="cur_user-img" src="<?= Yii::$app->user->identity->user_photo; ?>">
        ...
        <div class="content_menu-container">
            <div class="content_container">
                ...
                <ul class="content_menu">
                    ...
                    <li class="content_item"><?= Html::a('Пользователи', ['/admin/user/index']) ?></li>
