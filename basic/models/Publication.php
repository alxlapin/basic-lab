...
class Publication extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(User::className(), ['id' => 'user_id'])->viaTable('user_publication', ['public_id' => 'id']);
    }
