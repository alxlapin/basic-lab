...
<div class="labuser-one labuser-view">
    <p>
        <?= Html::a('Редактировать', ['update'], ['class' => 'btn btn-primary btn-own']) ?>
        <?= Html::a('Изменить пароль', ['password-change'], ['class' => 'btn btn-primary btn-own']) ?>
    </p>
    ...
    <div class="labuser-mainblock">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane" id="labuser-publics">
                <?= Html::a('Редактировать', ['publication-edit/index'], ['class' => 'btn btn-primary btn-own']) ?>
            ...
            <div class="tab-pane" id="labuser-projects">
                <?= Html::a('Редактировать', ['project-edit/index'], ['class' => 'btn btn-primary btn-own']) ?>
            ...
            <div class="tab-pane" id="labuser-achieves">
                <?= Html::a('Редактировать', ['achievement-edit/index'], ['class' => 'btn btn-primary btn-own']) ?>
